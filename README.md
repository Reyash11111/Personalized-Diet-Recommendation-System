...
- **Caloric Calculations**: Automatic calculation of daily caloric needs using Harris-Benedict formula
- **Personalized Recommendations**: Get customized meal plans based on:
  - Age, weight, height, and gender
  - Activity level
  - Fitness goal (Weight Loss, Muscle Gain, Maintenance)
  - Dietary restrictions
- **Meal Planning**: Daily meal suggestions for breakfast, lunch, snack, and dinner
- **Profile History**: View all saved profiles
